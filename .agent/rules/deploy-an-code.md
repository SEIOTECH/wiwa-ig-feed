...
| --------------- | ------ | -------------- | --------------------------------------------------------------------------------- | -------------- |
| **Development** | `dev`  | Push to `dev`  | `/home/wiwatour-dev/htdocs/dev.wiwatour.com/wp-content/plugins/wiwa-tour-ig-feed` | `wiwatour-ssh` |
...
- `SSH_PRIVATE_KEY`: Private key for `wiwatour-ssh`.
